...
func makeAllGhosts(){
    ...
    makeAGhost(name: "Cry Baby", withThe: "3StarsGhost.png", skulls: "3Skulls", percent: 0.2, description: "His cry can be heard for miles away, he haunts the sad people and feeds on their pain. Make no mistake about the size, this little guy can be very scary!", withThe: "naoSelecionadoFantasma4.png")

    makeAGhost(name: "Casper", withThe: "4StarsGhost.png", skulls: "4Skulls", percent: 0.15, description: "Despite the name, this ghost is not friendly at all, he is extremely needy and when he finds a haunting victim he never leaves.", withThe: "naoSelecionadoFantasma3.png")
...
//Tasks
func creatAllTasks(){
    createATask(title: "Catch 'Em All", description: "Catch at least one ghost os each")
    
    (UIApplication.shared.delegate as! AppDelegate).saveContext()
}

func createATask(title: String, description:String) {
